...
$aclLink = $this->Html->url( array( "controller" => "settings", "action" => "acl"));
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Rootx Admin</a>
            </div>
            <!-- /.navbar-header -->
			...
			?>
                        <li><a href="<?php echo $logoutLink; ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
...
$dashboardLink = $this->Html->url( array( "controller" => "users", "action" => "index"));

		  ?>
                            <a href="<?php echo $dashboardLink; ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
			<?php
		  ...
		  ?>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo $aclLink; ?>">Access Control List</a>
                                </li>
                                <li>
								<a href="<?php echo $settingsLink; ?>"> Settings Website</span></a>
								</li>
                            </ul>
                        </li>
                        <li>
